...
2. Ios:
    ...
    2. open the ios project , put the fonts folder under project-name => project-name => here (leave as default options in the import options)
